...
public class Task2 {
    public static void main(String[] args) {
        ...
        int bb = b++;
        int e = (5 + bb) / 8;// (5 + 2++) / 8 = (5 + 2) / 8 = 0 (круглые скобки повышают приоритет заключенных в них операций, инкремент-> сложение -> деление)
        ...
        int g = ((5 * 2 >> bb) / aa);// (5 * 2 >> 2) / 7 = (10 >> 2) / 7 = ((00001010>>2=00000010)) / 7 = 2 / 7 = 0 (в скобках -инкремент-> умножение->сдвиг,далее декремент,далее деление)
        System.out.println("(5 * 2 >> 2++) / --8 =" + g);
        int h = ((5 + 7 > 20 ? 68 : 22 * 2 >> bb) / aa);// (12>20?68:22*2>>2)/ 7 : 12 меньше 20 , значит берем вторую часть:(22*2>>2)/7=(44>>2)/7= ((00101100>>2)=00001011/7=11/7=1
